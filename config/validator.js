(function() {
     ...
     * @created  : 28122016
     * @modified : 28122016
     * @purpose  : To validate price
     * @return   : true, false
     * @public
     */
    function isValidPrice(price){
        return /^\d{0,9}(\.\d{1,2})?$/.test(price);
    }
     ...
     * @created  : 28122016
     * @modified : 28122016
     * @purpose  : To validate company_name
     * @return   : true, false
     * @public
     */
    function isValidCompanyName(company_name){
        return /^[.@&]?[a-zA-Z0-9 ]+[ !.@&()]?[ a-zA-Z0-9!()]+/.test(company_name);
    }
