(function () {
	...
	function () {
		...
		}]).controller("ModalInstanceCtrl1", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
			$scope.items = items, $scope.selected = {
				item: $scope.items[0]
			}, $scope.ok = function () {
				$modalInstance.close($scope.selected.item)
		...
		.controller("ModalDemoCtrl2", ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
				$scope.items = ["item1", "item2", "item3"], $scope.open = function () {
					var modalInstance;
					modalInstance = $modal.open({
			...
			}]).controller("ModalInstanceCtrl2", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
				$scope.items = items, $scope.selected = {
					item: $scope.items[0]
				}, $scope.ok = function () {
					$modalInstance.close($scope.selected.item)
			...
			.controller("ModalDemoCtrl4", ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
				$scope.items = ["item1", "item2", "item3"], $scope.open = function () {
					var modalInstance;
					modalInstance = $modal.open({
			...
			}]).controller("ModalInstanceCtrl4", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
				$scope.items = items, $scope.selected = {
					item: $scope.items[0]
				}, $scope.ok = function () {
					$modalInstance.close($scope.selected.item)
			...
			.controller("ModalDemoCtrl5", ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
				$scope.items = ["item1", "item2", "item3"], $scope.open = function () {
					var modalInstance;
					modalInstance = $modal.open({
			...
			}]).controller("ModalInstanceCtrl5", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
				$scope.items = items, $scope.selected = {
					item: $scope.items[0]
				}, $scope.ok = function () {
					$modalInstance.close($scope.selected.item)
			...
			.controller("ModalDemoCtrl6", ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
				$scope.items = ["item1", "item2", "item3"], $scope.open = function () {
					var modalInstance;
					modalInstance = $modal.open({
			...
			}]).controller("ModalInstanceCtrl6", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
				$scope.items = items, $scope.selected = {
					item: $scope.items[0]
				}, $scope.ok = function () {
					$modalInstance.close($scope.selected.item)
			...
			.controller("ModalDemoCtrl7", ["$scope", "$modal", "$log", function ($scope, $modal, $log) {
				$scope.items = ["item1", "item2", "item3"], $scope.open = function () {
					var modalInstance;
					modalInstance = $modal.open({
						templateUrl: "myModalContent7.html",
			...
			}]).controller("ModalInstanceCtrl7", ["$scope", "$modalInstance", "items", function ($scope, $modalInstance, items) {
				$scope.items = items, $scope.selected = {
					item: $scope.items[0]
				}, $scope.ok = function () {
					$modalInstance.close($scope.selected.item)
	...
	function () {
		...
		angular.module("app", ["ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart", "mgo-angular-wizard", "textAngular", "ui.tree", "ngMap", "ngTagsInput", "app.ui.ctrls", "app.ui.directives", "app.ui.services", "app.controllers", "app.directives", "app.form.validation", "app.ui.form.ctrls", "app.ui.form.directives", "app.tables", "app.map", "app.task", "app.localization", "app.chart.ctrls", "app.chart.directives", "app.page.ctrls"]).config(["$routeProvider", function ($routeProvider) {
			return $routeProvider.when("/", {
					redirectTo: "/hospitalMngt"
				})
				.when("/hospitalMngt", {
					templateUrl: "views/hospitalMngt.html"
				})
				.when("/usermanagement", {
					templateUrl: "views/usermanagement.html"
				})
				.when("/add_usermanagement", {
					templateUrl: "views/add_usermanagement.html"
				})
				.when("/view_usermanagement", {
					templateUrl: "views/view_usermanagement.html"
				})
				.when("/edit_usermanagement", {
					templateUrl: "views/edit_usermanagement.html"
				})
				.when("/suppliers", {
					templateUrl: "views/suppliers.html"
				})
				.when("/view_supplier", {
					templateUrl: "views/view_supplier.html"
				})
				.when("/add_supplier", {
					templateUrl: "views/add_supplier.html"
				})
				.when("/edit_supplier", {
					templateUrl: "views/edit_supplier.html"
				})
				.when("/view_supplier_item", {
					templateUrl: "views/view_supplier_item.html"
				})
				.when("/form_builder", {
					templateUrl: "views/form_builder.html"
				})
				.when("/add_form", {
					templateUrl: "views/add_form.html"
				})
				.when("/view_form_1", {
					templateUrl: "views/view_form_1.html"
				})
				.when("/view_form_2", {
					templateUrl: "views/view_form_2.html"
				})
				.when("/edit_form", {
					templateUrl: "views/edit_form.html"
				})
				.when("/edit_profile", {
					templateUrl: "views/pages/edit_profile.html"
				})
				.when("/clients", {
				...
				.when("/view_clientmanagement", {
					templateUrl: "views/view_clientmanagement.html"
				})
				.when("/appointments", {
					templateUrl: "views/appointments.html"
				})
				.when("/assessmentform", {
					templateUrl: "views/assessmentform.html"
				})
				.when("/ui/typography", {
				...
				.when("/nd_order_sheet", {
					templateUrl: "views/nursing_director_order_sheet_edit.html"
				})
				.when("/patient_facesheet", {
					templateUrl: "views/fb_patient_facesheet.html"
				})
				.when("/medical_history", {
					templateUrl: "views/fb_medical_history.html"
				})
				.when("/health_assessment", {
					templateUrl: "views/fb_health_assessment.html"
				})
				.when("/nursing_assessment", {
					templateUrl: "views/fb_nursing_assessment.html"
				})
				.when("/daily_progress_note", {
					templateUrl: "views/fb_daily_progress_note.html"
				})
				.when("/physician_admitting_orders", {
					templateUrl: "views/fb_physician_admitting_orders.html"
				})
				.when("/leads", {
					templateUrl: "views/leads.html"
				})
				.when("/leads_edit", {
					templateUrl: "views/leads_edit.html"
				})
				.when("/leads_edit1", {
					templateUrl: "views/leads_edit1.html"
				})
				.when("/leads_edit2", {
					templateUrl: "views/leads_edit2.html"
				})
				.when("/leads_view", {
					templateUrl: "views/leads_view.html"
				})
				.when("/leads_view1", {
					templateUrl: "views/leads_view1.html"
				})
				.when("/leads_view2", {
					templateUrl: "views/leads_view2.html"
				})
				.when("/leads_assign", {
					templateUrl: "views/leads_assign.html"
				})
				.when("/schedule", {
					templateUrl: "views/schedule.html"
				})
				.when("/clinical_notes", {
					templateUrl: "views/clinical_notes.html"
				})
				.when("/edit_clientmanagement", {
					templateUrl: "views/edit_clientmanagement.html"
				})
				.when("/care_plan", {
					templateUrl: "views/care_plan.html"
				})
				.when("/service_list_clientmanagement", {
					templateUrl: "views/service_list_clientmanagement.html"
				})
				.when("/staff_management", {
					templateUrl: "views/staff_management.html"
				})
				.when("/view_client_Information", {
				   templateUrl: "views/view_client_Information.html"
					})
				.when("/view_Care_Plan", {
					templateUrl: "views/view_Care_Plan.html"
					})
				.when("/view_Medical", {
					templateUrl: "views/view_Medical.html"
					})
			
			.when("/view_Observations", {
					templateUrl: "views/view_Observations.html"
					})

			.when("/view_Preferences", {
					templateUrl: "views/view_Preferences.html"
					})
			
			.when("/view_Clinical_Notes", {
					templateUrl: "views/view_Clinical_Notes.html"
					})
			.when("/view_Schedule", {
					templateUrl: "views/view_Schedule.html"
					})
