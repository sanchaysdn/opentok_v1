...
// Get Activity Measures
client.getActivity = function (startDate,endDate, cb) {
    var params = {
...
client.getSteps = function (startDate,endDate, cb) {
    this.getActivity(startDate,endDate, function (err, data) {
        if (err) {
            return cb(err);
        }
        try {
...
client.getCalories = function (startDate,endDate, cb) {
    this.getActivity(startDate,endDate, function (err, data) {
        if (err) {
            return cb(err);
        }
